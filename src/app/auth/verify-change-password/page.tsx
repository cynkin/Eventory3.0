...
export default function VerificationPage() {
    ...
    async function handleSendOtp() {
        try {
            setError("");
            await sendOTP({purpose: "CHANGE_PASSWORD"});
    ...
    useEffect(() => {
        ...
        sendOTP({purpose:"CHANGE_PASSWORD"})
            .then(() => {
                setCooldown(COOLDOWN_TIME);
            })
            .catch(() => {
            ...
            <div className="w-115">
                <div className="flex flex-col items-center ">
                    ...
                    <div className="mt-2 pl-2 self-start text-gray-700 text-md">
                        <div>To continue, enter the secure code sent to {session?.user.email ? session.user.email : "null"}. Check junk mail if it’s not in your inbox.</div>
